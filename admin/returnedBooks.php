                    ...
                    <li>
                        ...
                        <div class="collapse show" id="manage">
                            <ul class="navbar-nav ps-3">
                                ...
                                <li>
                                    <a href="returnedBooks.php" class="nav-link px-3 active">
                                        <span class="me-2"><i class="bi bi-book-fill"></i></i></span>
                ...
                <div class="col-md-12">
                    ...
                    <div class="border border-secondary border-opacity-25 p-3 overflow-auto rounded">
                        <table class="table table-striped table-hover text-nowrap">
                            ...
                            <tbody>
                            <?php
                                   $query = "SELECT books.ISBN, books.book_title, books.book_author, books.book_category, students.s_ID, book_transactions.bt_date 
                                   FROM ((book_transactions
                                   INNER JOIN books ON book_transactions.ISBN = books.ISBN)
                                   INNER JOIN students ON book_transactions.s_ID = students.s_ID) WHERE bt_status = '3' ";
