                    ...
                    <li>
                        ...
                        <div class="collapse show" id="books">
                            <ul class="navbar-nav ps-3">
                                ...
                                <li>
                                    <a href="requestLogs.php" class="nav-link px-3 active">
                                        <span class="me-2"><i class="bi bi-book-fill"></i></i></span>
                    ...
                    <div class="border border-secondary border-opacity-25 p-3 overflow-auto rounded">
                        <table class="table table-striped table-hover">
                            ...
                            <?php include "message.php" ?>
                                <?php
                                   $query = "SELECT books.ISBN, books.book_title, books.book_author, books.book_category, book_transactions.s_ID, book_transactions.bt_date, book_transactions.bt_status
                                   FROM ((book_transactions 
                                   INNER JOIN books ON book_transactions.ISBN = books.ISBN)
                                   INNER JOIN students ON book_transactions.s_ID = students.s_ID) ";
                                        ...
                                        if ($book['bt_status'] == 0) {
                                            ?>
                                                <td class="d-flex align-items-center m-0">
                                                    <div class="btn btn-info mt-2">Pending</div>
                                                </td>
                                            </tr>
                                            <?php
                                            ...
                                            ?>
                                                <td class="d-flex align-items-center m-0">
                                                    <div class="btn btn-success mt-2">Approved</div>
                                                </td>
                                                </tr>
                                           <?php
                                            ...
                                            ?>
                                                <td class="d-flex align-items-center m-0">
                                                    <div class="btn btn-danger mt-2">Declined</div>
                                                </td>
                                                </tr>
                                            <?php
                                        } 
                                            ...
                                            ?>
                                                <td class="d-flex align-items-center m-0">
                                                    <div class="btn btn-secondary mt-2">Returned</div>
                                                </td>
                                                </tr>
                                            <?php
                                        }
