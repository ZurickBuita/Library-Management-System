                    ...
                    <li>
                        ...
                        <div class="collapse show" id="manage">
                            <ul class="navbar-nav ps-3">
                                <li>
                                    <a href="borrowedBooks.php" class="nav-link px-3 active">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <?php include 'message.php'; ?>
                                <?php
                                    ...
                                    INNER JOIN students ON book_transactions.s_ID = students.s_ID) WHERE bt_status = '1' ";
                                    ...
                                    if (mysqli_num_rows($query_run) > 0) {
                                        foreach($query_run as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-1 m-0 ">
                                                   <button class="btn btn-primary mt-2 py-1">Borrowed</button>
                                                </td>
                                            </tr>
                                            <?php
                                        }
