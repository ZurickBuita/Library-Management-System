                                        ...
                                        if ($book['bt_status'] == 0) {
                                            ?>
                                                <td class="d-flex align-items-center">
                                                    <div class="btn btn-info mt-2 py-1">Pending</div>
                                                </td>
                                            </tr>
                                            <?php
                                            ...
                                            ?>
                                                <td class="d-flex align-items-center">
                                                    <div class="btn btn-success mt-2 py-1">Approved</div>
                                                </td>
                                                </tr>
                                           <?php
                                            ...
                                            ?>
                                                <td class="d-flex align-items-center">
                                                    <div class="btn btn-danger mt-2 py-1">Declined</div>
                                                </td>
                                                </tr>
                                            <?php
                                        } 
                                            ...
                                            ?>
                                                <td class="d-flex align-items-center">
                                                    <div class="btn btn-secondary mt-2 py-1">Returned</div>
                                                </td>
                                                </tr>
                                            <?php
                                        }
